// Helper function to parse CSV data from a string slice
fn parse_csv(csv_content: &str) -> Vec<Vec<String>> {
...
pub fn get_csv_data(file_name: &str) -> Vec<Vec<String>> {
    let csv_content = match file_name {
        ...
        "top10_ActionScript.csv" => include_str!("../data/processed/top10_ActionScript.csv"),
        "top10_C.csv" => include_str!("../data/processed/top10_C.csv"),
        "top10_Clojure.csv" => include_str!("../data/processed/top10_Clojure.csv"),
        "top10_CoffeeScript.csv" => include_str!("../data/processed/top10_CoffeeScript.csv"),
